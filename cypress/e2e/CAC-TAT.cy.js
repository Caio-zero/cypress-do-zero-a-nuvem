describe('Central de Atendimento ao Cliente TAT', () => {
  ...
  it("preenche os campos obrigatórios e envia o formulário", () => {
    ...
    cy.get('#email').type('caio.test@testando.com.br')
    ...
    it('exibe mensagem de erro ao submeter o formulário com um email com formatação inválida', () => {
      cy.get('#firstName').type('Caio')
      cy.get('#lastName').type('Nunes')
      cy.get('#email').type('caio.test@testando,com')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', () => {
      ...
      cy.get('#lastName')
       ...
       .should('have.value', '')
      cy.get('#email')
       .type('caio.test@testando,com')
       .should('have.value', 'caio.test@testando,com')
       .clear()
       .should('have.value', '')
      cy.get('#phone')
       .type('123456789')
